...
const WarehouseManagement = () => {
  ...
  // State variables for the new modal
  ...
  // Modal handling for adding product to warehouse
  ...
  const handleAddProductToWarehouse = () => {
    axios.post('http://localhost:3000/api/inventory/add', {
      id: user.id,
  ...
  // Filter products based on selected category for the modal
  ...
  return (
    <>
      ...
      <Container>
        <Tabs defaultActiveKey="interest" id="warehouse-tabs" style={{ marginTop: '10px' }}>
          ...
          <Tab eventKey="warehouse" title="Προϊόντα Εντός Αποθήκης">
            <h1 style={{ marginTop: '20px' }}>
              Προϊόντα Εντός Αποθήκης
              <Button variant="primary" style={{ float: 'right', marginBottom: '10px' }} onClick={openAddProductModal}>
                + Προσθήκη Προϊόντος
              </Button>
            </h1>
            <Table striped bordered hover>
      ...
      {/* Modal for adding product to warehouse */}
      <Modal show={addProductModalIsOpen} onHide={closeAddProductModal}>
        <Modal.Header closeButton>
          <Modal.Title>Προσθήκη Προϊόντος στην Αποθήκη</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Group>
              ...
              <Select
                ...
                onChange={selectedCategory => handleCategoryFilterChange(selectedCategory?.value)}
                isClearable
              />
            </Form.Group>
            <Form.Group>
              ...
              <Select
                ...
                onChange={selectedOption => setNewProduct({ ...newProduct, product: selectedOption.value })}
              />
            </Form.Group>
            <Form.Group>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={closeAddProductModal}>Κλείσιμο</Button>
          <Button variant="primary" onClick={handleAddProductToWarehouse}>Προσθήκη</Button>
        </Modal.Footer>
      </Modal>
    </>
  );
